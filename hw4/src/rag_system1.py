...
class DocumentStoreComponent:
    def __init__(self, vectordb_path: str, collection_name: str):
        ...
        self.child_spliter = RecursiveCharacterTextSplitter(chunk_size=512, chunk_overlap=50)
        self.parent_spliter = RecursiveCharacterTextSplitter(chunk_size=512 * 3, chunk_overlap=50 * 3)
